...
> 最后更新：2026-06-02（v1.0 部署上线）

## 项目一句话

暗色电影感 / 中文 / 高级感的 opcmode 个人品牌站。React SPA，3 路由，Vercel 自动部署。
...
| 顶部菜单项 | `src/components/Navbar.tsx`（`NAV_ITEMS`） |
...
1. 🔥 **Story 故事正文**：`src/pages/StoryPage.tsx` 找 `<section className="story-content">`，把占位文案换成自己的故事
2. ⭐ 视频素材替换：自己拍或 Pexels 找
3. ⭐ 补 favicon + og:image
4. 中等：剩余 5 节点（创作集 / 工作坊 / 联系 / 项目 / 文章）

完整维护手册：`docs/.omc/MAINTAIN.md`
完整方案档案：`docs/.omc/final-plan.md`
