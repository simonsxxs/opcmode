import{_ as a,I as s,c as i,o as r,a5 as l,j as e,J as d,a as n,aG as u}from"./chunks/framework.Dtwt352Q.js";const C=JSON.parse('{"title":"B3 Documentation & Git","description":"Use AI to auto-generate README documentation, Git commit messages, and Pull Request descriptions to improve collaboration efficiency.","frontmatter":{"title":"B3 Documentation & Git","subtitle":"Auto-generate README, commit, PR","course":"OpenCode Practical Course","stage":"Stage 4","lesson":"B3","duration":"15 min","practice":"20 min","level":"Advanced","description":"Use AI to auto-generate README documentation, Git commit messages, and Pull Request descriptions to improve collaboration efficiency.","tags":["Documentation","Git","README","commit"],"prerequisite":["B1 Developer Daily"]},"headers":[],"relativePath":"en/4-scenarios/coder-docs-git.md","filePath":"en/4-scenarios/coder-docs-git.md","lastUpdated":1772014034000}'),p={name:"en/4-scenarios/coder-docs-git.md"};function c(m,t,g,h,b,f){const o=s("AdInArticle");return r(),i("div",null,[t[0]||(t[0]=l('<h1 id="b3-documentation-git" tabindex="-1">B3 Documentation &amp; Git <a class="header-anchor" href="#b3-documentation-git" aria-label="Permalink to “B3 Documentation &amp; Git”">​</a></h1><blockquote><p>💡 <strong>One-liner</strong>: Use AI to auto-generate README, commit messages, and PR descriptions.</p></blockquote><h2 id="📝-course-notes" tabindex="-1">📝 Course Notes <a class="header-anchor" href="#📝-course-notes" aria-label="Permalink to “📝 Course Notes”">​</a></h2><p>Key takeaways from this lesson:</p><p><img src="'+u+'" alt="B3 Documentation &amp; Git Notes" data-zoom-src="/images/4-scenarios/coder-docs-git-notes.jpeg"></p><hr><h2 id="what-you-ll-be-able-to-do" tabindex="-1">What You&#39;ll Be Able to Do <a class="header-anchor" href="#what-you-ll-be-able-to-do" aria-label="Permalink to “What You&#39;ll Be Able to Do”">​</a></h2><ul><li>Auto-generate project README</li><li>Let AI write commit messages</li><li>Generate PR descriptions</li><li>Use /undo /redo with Git integration</li></ul><hr><h2 id="your-current-struggles" tabindex="-1">Your Current Struggles <a class="header-anchor" href="#your-current-struggles" aria-label="Permalink to “Your Current Struggles”">​</a></h2><ul><li>README writing is painful, or you just skip it</li><li>Commit messages are sloppy, hard to understand later</li><li>PR descriptions - no idea how to write them properly</li></ul><hr><h2 id="when-to-use-this" tabindex="-1">When to Use This <a class="header-anchor" href="#when-to-use-this" aria-label="Permalink to “When to Use This”">​</a></h2><ul><li>When you need to: efficiently complete documentation and Git collaboration tasks</li><li>And don&#39;t want to: spend too much time on these &quot;chores&quot;</li></ul><hr><h2 id="🎒-before-you-start" tabindex="-1">🎒 Before You Start <a class="header-anchor" href="#🎒-before-you-start" aria-label="Permalink to “🎒 Before You Start”">​</a></h2><blockquote><p>Make sure you&#39;ve completed the following:</p></blockquote><ul><li>[ ] Completed <a href="./coder-daily.html">B1 Developer Daily</a></li><li>[ ] Project has Git initialized (<code>git init</code>)</li></ul><hr><h2 id="core-concept" tabindex="-1">Core Concept <a class="header-anchor" href="#core-concept" aria-label="Permalink to “Core Concept”">​</a></h2><h3 id="documentation-automation-scenarios" tabindex="-1">Documentation Automation Scenarios <a class="header-anchor" href="#documentation-automation-scenarios" aria-label="Permalink to “Documentation Automation Scenarios”">​</a></h3><table tabindex="0"><thead><tr><th>Doc Type</th><th>When to Generate</th><th>AI Assistance</th></tr></thead><tbody><tr><td>README</td><td>Project start / major updates</td><td>Analyze project structure</td></tr><tr><td>API Docs</td><td>After interface development</td><td>Extract from code</td></tr><tr><td>Commit Message</td><td>Each commit</td><td>Analyze changes</td></tr><tr><td>PR Description</td><td>Submitting PR</td><td>Summarize commits</td></tr></tbody></table><hr><h2 id="follow-along" tabindex="-1">Follow Along <a class="header-anchor" href="#follow-along" aria-label="Permalink to “Follow Along”">​</a></h2><h3 id="step-1-generate-readme" tabindex="-1">Step 1: Generate README <a class="header-anchor" href="#step-1-generate-readme" aria-label="Permalink to “Step 1: Generate README”">​</a></h3><p><strong>Why</strong> A good README is the face of your project.</p><p>Switch to Build Agent:</p>',27)),t[1]||(t[1]=e("div",{class:"language-"},[e("button",{title:"Copy Code",class:"copy"}),e("span",{class:"lang"}),e("pre",null,[e("code",{"v-pre":""},`@explore Analyze the project structure and generate a professional README.md:
